...
namespace SYNKproject1
{
    public class BGandPGpayment : DriversRoot
    {
        ...
        public void BgAndPGpayment(string kundnummer, string belopp, string mottagare)
        {
            ...
            CashDeskWindowSession.FindElementByAccessibilityId("txtPGBGMessage").SendKeys("7904130361000000");
