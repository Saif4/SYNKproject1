...
{
    public class EngagementView : DriversRoot
    {
        ...
        public void SelectStartupPage(string selectStartupPage)
        {
            ...
            Assert.AreEqual(valavbehörighet, "Engagemang");
        ...
        public void VerifySelectedPage(string kundnummer)
        {
            ...
            // Väljer kunduppgifter vy och verifierar att rätt vy är öppet
            CustomerFormWindowSession.FindElementByName("&1 Kunduppgifter").Click();
            var kunduppgiftervyn = CustomerFormWindowSession.FindElementByName(kundnummer).Displayed;
