...
namespace SYNKproject1
{
    public class CardConnectedToAccount : DriversRoot
    {
        ...
        public void CardAccountConnection(string kontonummer)
        {
            ...
            // Går in konto översikten och hämtar ut personnummret 
            ...
            // Verifierar att kontonummert och personnummret i kort översikten stämmer med kontot som är kopplat till
