...
{
    public class MeetingManagementCompanies : DriversRoot
    {
        ...
        public void NextMeeting(string datum, string klockan, string notering, string plats)
        {
            ...
            CustomerFormWindowSession.Keyboard.SendKeys(Keys.ArrowDown + Keys.ArrowDown + Keys.ArrowDown + Keys.ArrowRight + Keys.ArrowDown + Keys.ArrowRight + Keys.ArrowDown + Keys.Enter);
        ...
        public void RejectedMeeting(string avböjdDatum, string notering, string nästaDatum, string nyNotering)
        {
            // Går in på nästa möte 
            CustomerFormWindowSession.FindElementByName("Visa kundinfo").Click();
            CustomerFormWindowSession.Keyboard.SendKeys(Keys.ArrowDown + Keys.ArrowDown + Keys.ArrowDown + Keys.ArrowRight + Keys.ArrowDown + Keys.ArrowRight + Keys.ArrowDown + Keys.ArrowDown + Keys.Enter);
        ...
        public void AddNotice(string notering)
        {
            ...
            CustomerFormWindowSession.FindElementByName("Visa kundinfo").Click();
            CustomerFormWindowSession.Keyboard.SendKeys(Keys.ArrowDown + Keys.ArrowDown + Keys.ArrowDown + Keys.ArrowRight + Keys.ArrowDown + Keys.ArrowRight + Keys.Enter);
            CustomerFormWindowSession.FindElementByName("Notering:").SendKeys(notering);
            CustomerFormWindowSession.FindElementByName("Open").Click();
            CustomerFormWindowSession.Keyboard.SendKeys(Keys.ArrowDown + Keys.Enter);
            CustomerFormWindowSession.FindElementByName("OK").Click();
