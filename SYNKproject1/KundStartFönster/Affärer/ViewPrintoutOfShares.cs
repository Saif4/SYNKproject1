...
{
    public class ViewPrintoutOfShares : DriversRoot
    {
        ...
        public void OpenPrintoutPageForShares()
        {
            ...
            CustomerFormWindowSession.Keyboard.SendKeys(Keys.ArrowUp + Keys.ArrowUp + Keys.ArrowUp + Keys.ArrowUp + Keys.ArrowUp + Keys.ArrowRight + Keys.ArrowDown + Keys.Enter);
            var PrintOutPage = CustomerFormWindowSession.FindElementByAccessibilityId("frmVPOrder").Displayed;
            CustomerFormWindowSession.FindElementByName("Avbryt").Click();
        }
    }
}
