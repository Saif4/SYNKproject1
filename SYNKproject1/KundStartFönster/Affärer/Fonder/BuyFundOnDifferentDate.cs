...
{
    public class BuyFundOnDifferentDate : DriversRoot
    {
        ...
        public BuyFundOnDifferentDate()
        {
            PageFactory.InitElements(DriversRoot.RootSession, this);
        }

        public void BuyFund(string belopp, string konto, string datum)
        {
            ...
            WindowsElement buy = CustomerFormWindowSession.FindElementByName("Köp på tidigare datum");
            ...
            CustomerFormWindowSession.FindElementByName("Tidigare köpdatum:").SendKeys(datum);
