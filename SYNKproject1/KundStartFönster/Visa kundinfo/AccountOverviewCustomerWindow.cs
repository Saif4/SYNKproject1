...
{
    public class AccountOverviewCustomerWindow : DriversRoot
    {
        ...
        public void AccountOverviewCustomerwindow()
        {
            ...
            WindowsElement click = CustomerFormWindowSession.FindElementByName("Kortöversikt...");
            ...
            var AccountOverviewWindow = RootSession.FindElementByAccessibilityId("frmKortView").Displayed;
            RootSession.FindElementByAccessibilityId("frmKortView").FindElementByName("OK").Click();
