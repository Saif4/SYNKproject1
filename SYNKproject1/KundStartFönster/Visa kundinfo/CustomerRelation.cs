...
{
    public class CustomerRelation : DriversRoot
    {
        public WindowsDriver<WindowsElement> CustomerFormWindowSession;
        public void ViewCustomerRelation()
        {
            ...
            // Går in på kundstruktor och väljer relationer 
            CustomerFormWindowSession.FindElementByName("Visa kundinfo").Click();
            WindowsElement click = CustomerFormWindowSession.FindElementByName("Relationer...");
            ...
            var ASKOverviewWindow = RootSession.FindElementByAccessibilityId("frmRelationer").Displayed;
            RootSession.FindElementByAccessibilityId("frmRelationer").FindElementByName("OK").Click();
        }
    }
}
